...
try:
    ...
    dst_dir = (r"C:\Users\Harry\OneDrive\Hockey\Results and Analysis\2023-2024\D1\Previous\D1_1K_results_2324_"
               + str(now) + ".xlsx")
except IOError:
    old_results = pd.read_excel(file_path_big, sheet_name='All Results')
    file_path = file_path_big
    dst_dir = (r"C:\Users\Harry Higgins\OneDrive\Hockey\Results and Analysis\2023-2024\D1\Previous\D1_1K_results_2324_"
               + str(now) + ".xlsx")
