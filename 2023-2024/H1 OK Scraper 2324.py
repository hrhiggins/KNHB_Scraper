...
z = shadow.chrome_driver.get('https://www.knhb.nl/match-center#/competitions/N5/results')
...
try:
    ...
    dst_dir = (r"C:\Users\Harry\OneDrive\Hockey\Results and Analysis\2023-2024\H1\Previous\H1_OK_results_2324_"
               + str(now) + ".xlsx")
except IOError:
    old_results = pd.read_excel(file_path_big, sheet_name='All Results')
    file_path = file_path_big
    dst_dir = (r"C:\Users\Harry Higgins\OneDrive\Hockey\Results and Analysis\2023-2024\H1\Previous\H1_OK_results_2324_"
               + str(now) + ".xlsx")
